...
func TestFetchArticle(t *testing.T) {
	tests := []struct {
		...
		{"https://china.kyodonews.net/news/2021/10/34c0cb6f7246-60-.html", ErrTimeOverDays},
	}
...
func TestFetchTitle(t *testing.T) {
	tests := []struct {
		...
		{"https://china.kyodonews.net/news/2021/10/34c0cb6f7246-60-.html", "东京新确诊60人感染新冠 减至今年最少"},
	}
	for _, tc := range tests {
		a := NewArticle()
...
func TestFetchUpdateTime(t *testing.T) {
	tests := []struct {
		...
		{
			"https://china.kyodonews.net/news/2021/10/34c0cb6f7246-60-.html",
			"2021-10-11 18:34:56 +0800 UTC",
		},
	}
	var err error
	for _, tc := range tests {
